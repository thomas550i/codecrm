<template>
  <LayoutHeader>
    <template #left-header>
      <ViewBreadcrumbs v-model="viewControls" routeName="Opportunitys" />
    </template>
  ...
  <div v-else-if="deals.data" class="flex h-full items-center justify-center">
    ...
    >
      ...
      <span>{{ __('No {0} Found', [__('Opportunitys')]) }}</span>
...
import OpportunityListView from '@/components/ListViews/OpportunityListView.vue'
